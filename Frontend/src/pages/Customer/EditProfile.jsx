        ...
        <div className="mx-auto max-w-5xl space-y-8 p-5 sm:p-8">
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-emerald-500 hover:bg-emerald-50 hover:text-emerald-600"
            >
              ← Back
            </button>
          </div>
            ...
            <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-xl shadow-slate-200/50 backdrop-blur-xl sm:p-8">
              ...
              <div className="mb-8 flex flex-col items-center gap-5 rounded-2xl bg-slate-50/80 p-6 sm:flex-row">
                ...
                <div className="relative">
                  <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border-8 border-white bg-linear-to-br from-emerald-100 via-teal-100 to-slate-200 text-3xl font-bold text-emerald-700 shadow-lg">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <label
                    className={`mt-4 inline-flex cursor-pointer rounded-xl border border-emerald-200 bg-white px-4 py-2.5 text-sm font-semibold text-emerald-600 shadow-sm hover:bg-emerald-50 ${
          ...
          <section className="flex flex-col items-start justify-between gap-5 rounded-3xl border border-red-200 bg-red-50/80 p-6 shadow-lg shadow-red-100/50 sm:flex-row sm:items-center sm:p-8">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-6 text-red-700">
                ...
                listings, swap history and messages. This action cannot be
                undone.
              </p>
            </div>
