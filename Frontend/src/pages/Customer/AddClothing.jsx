    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          console.log("ADD CLOTHING LOCATION:", {
            latitude,
            longitude,
          });
          ...
          toast.error(error.message || "Unable to determine your location.");
        } finally {
          setLocating(false);
        }
      },
      (error) => {
        ...
        if (error.code === 1) {
          ...
          toast.error("Location unavailable. Check Windows Location Services.");
            ...
            <section>
              ...
              <div className="mt-6 grid gap-6 sm:grid-cols-2">
                ...
                <button
                  ...
                  disabled={locating}
                  className="mt-4 inline-flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  📍
                  {locating
                    ? "Detecting location..."
