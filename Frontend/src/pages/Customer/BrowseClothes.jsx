...
export default function BrowseClothes() {
  ...
  const filteredItems = clothes.filter((item) => {
    ...
    const matchesCondition =
      !condition || item.clothing_condition === condition;
              ...
              {filteredItems.map((item) => (
                ...
                >
                  <div className="relative h-64 overflow-hidden bg-slate-100">
                    ...
                    <button
                      type="button"
                      className="absolute right-3 top-3 rounded-full bg-white p-2 text-slate-600 shadow hover:text-emerald-600"
                    >
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {[item.size, item.clothing_condition, item.category]
                        .filter(Boolean)
                        .map((tag) => (
                          <span
                            key={tag}
                    ...
                    <div className="mt-4 flex items-center gap-2 border-t border-slate-100 pt-4 text-sm">
                      ...
                      <span className="text-slate-600">{item.owner_name || "Unknown"}</span>
                    ...
                    <button
                      ...
                      className="mt-5 w-full rounded-xl bg-emerald-600 py-3 font-semibold text-white transition hover:bg-emerald-700 cursor-pointer"
                    >
                      View Details
                    </button>
                  </div>
