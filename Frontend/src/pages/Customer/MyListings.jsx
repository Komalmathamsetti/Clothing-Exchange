...
export default function MyListings() {
  ...
  const fetchListings = async () => {
    try {
      ...
      setListings(response.data.clothing || []);
    } catch (error) {
      console.log(error);
      toast.error(
            ...
            <>
              ...
              <div className="mb-8 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
                <div>
                  ...
                  <p className="mt-3 text-slate-500">
                    Manage the clothes you've shared with the ClothSwap
                    community.
                  </p>
                </div>
              ...
              <div className="mb-8 grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-3xl font-bold text-slate-900">
                    {
                      listings.filter((item) => item.status === "EXCHANGED")
                        .length
                    }
                  </p>
                </div>
              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:p-8">
                  ...
                  {listings.map((listing) => (
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-4">
                        <div className="h-16 w-16 overflow-hidden rounded-xl bg-emerald-50">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          onClick={() =>
                            navigate(`/edit-clothing/${listing.id}`)
                          }
                          className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-600 hover:border-emerald-300 hover:text-emerald-600 cursor-pointer"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          className="rounded-lg border border-red-200 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 cursor-pointer"
                        >
                          Delete
                        </button>
                      </div>
                ...
                <div className="mt-8 flex flex-col items-center justify-center rounded-2xl border border-dashed border-emerald-200 bg-emerald-50/40 px-6 py-8 text-center">
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Add another item and help someone find their next favorite
                    piece.
                  </p>
                </div>
              </section>
