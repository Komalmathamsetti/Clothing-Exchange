...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="fixed top-0 left-0 z-50 hidden h-screen w-72 flex-col border-r border-slate-200 bg-white md:flex">
        ...
        <nav className="flex-1 space-y-1 px-4 py-6">
          ...
          <NavLink to="/add-clothing" className={navClass}>
            👕 Add Clothing
          </NavLink>
          <NavLink to="/my-listings" className={navClass}>
            📦 My Listings
          </NavLink>
          <NavLink to="/browse-clothes" className={navClass}>
            🛍 Browse Clothes
          </NavLink>
          ...
          <NavLink to="/nearby-swaps" className={navClass}>
            📍 Nearby Swaps
          </NavLink>
          <NavLink to="/value-calculator" className={navClass}>
            💰 Value Calculator
          </NavLink>
